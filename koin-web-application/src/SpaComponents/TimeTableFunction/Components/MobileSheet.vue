    ...
    <div
      ...
      <div class="detail-table">
        <div
          ...
          <div class="subject-info">
            {{ convertClassTime(clickedSubject.class_time) }} / {{ clickedSubject.professor === " " ? "미배정" :
            clickedSubject.professor }} / {{ clickedSubject.code }}
          </div>
        ...
        <div
          ...
          <div
            ...
            <div
              ...
              <div class="subject-info">
                {{ convertClassTime(subject.class_time) }} / {{ subject.professor === " " ? "미배정" : subject.professor }}
                / {{ subject.code }}
              </div>
            </div>
            <button
